...
https://forum.arduino.cc/t/esp32-wifi-bluetooth-single-relay-module-sample-code/1439701

Compile for board ESP32 DEV Module (maybe other ESP32 boards work also)

To put in program upload mode:
1. Hold button IO0 (boot) in.
2. Press button EN momentarily
3. Release button IO0
4. Upload sketch
5. When upload is complete, again momentarily press button EN
...
#define SERVICE_UUID          "3b212f37-8512-46a0-9de4-d8ddd8ac74a0"  
#define CHARACTERISTIC_UUID_RX "bfc5bc7e-7f89-4694-95d4-f3413557609a"
#define CHARACTERISTIC_UUID_TX   "bf34b468-2732-4bb6-ba6e-819cd70ff73a"
